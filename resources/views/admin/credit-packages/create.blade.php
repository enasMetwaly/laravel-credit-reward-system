            ...
            <div class="form-card">
                ...
                <form action="{{ route('admin.credit-packages.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="price_egp" id="price_egp" class="form-control" step="0.01" value="{{ old('price_egp') }}" required>
                    </div>
                    <div class="form-group">
                        <label for="credits">Credits</label>
                        <input type="number" name="credits" id="credits" class="form-control" value="{{ old('credits') }}" required>
                    </div>
                    <div class="form-group">
                        <label for="reward_points">Reward Points</label>
                        <input type="number" name="reward_points" id="reward_points" class="form-control" value="{{ old('reward_points') }}" required>
                    </div>
                    <button type="submit" class="btn cta-btn">Create</button>
                </form>
            </div>
        </main>
    </div>
